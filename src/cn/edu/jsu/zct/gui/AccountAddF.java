...
public class AccountAddF extends JFrame {
	/**
	 ...
	 * @throws Exception 
	 */
	public AccountAddF(User_ user, Account acc) throws Exception {
		...
		if(acc!=null) {
			textFRmb.setText(""+acc.getRmb());
			textFTime.setText(""+acc.getTime());
			textFNote.setText(acc.getNote());
		}
